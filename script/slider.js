...
$(document).ready(function () {
    const sliderReviews = $('.reviews__slider').slick({
        centerMode: true,
        variableWidth: true,
        slidesToShow: 7,
        slidesToScroll: 1,
    ...
    $('.reviews__slider .slick-slide').on('click', function () {
        const index = $(this).data('slick-index');
        sliderReviews.slick('slickGoTo', index);
    });

    $('.reviews__button_prev').on('click', function () {
        sliderReviews.slick('slickPrev');
    });

    $('.reviews__button_next').on('click', function () {
